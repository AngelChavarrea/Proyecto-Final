    ...
    public partial class ucCampeonatoModificar: UC_Pantalla {
        ...
        public ucCampeonatoModificar(List<Object> lst_campeonato) {
            ...
            foreach (var campeonato in lst_campeonato) {
                ...
                //txtId_campeonato.Text = ((int)type.GetProperty("id_campeonato").GetValue(campeonato)).ToString();
        ...
        private void btnModificar_Click(object sender, EventArgs e) {
            String msj = "";
            try {
                //clsCampeonato.Id_campeonato = Convert.ToInt32(txtId_campeonato.Text);
